        ...
        return new Promise((resolve, reject) => {
            if(idx >= boardArr.length){
                resolve({
                    ...
                    json : authUtill.successFalse(responseMessage.NO_BOARD)
                });
                return;
            }
            resolve({
        ...
        return new Promise((resolve, reject) => {
            ...
            if (boardArr[idx].pwd !== pwd){
                resolve({
                    ...
                    json : authUtill.successFalse(responseMessage.MISS_MATCH_PW)
                });
                return;
            }
            ...
            resolve({
                code : statusCode.OK,
                json : authUtill.successTrue(responseMessage.BOARD_UPDATE_SUCCESS, boardArr[idx])
            });
        });
    },
    delete : (idx, pwd) => {
        return new Promise((resolve, reject) => {
            ...
            resolve({
                code : statusCode.OK,
                json : authUtill.successTrue(responseMessage.BOARD_DELETE_SUCCESS)
            });
        });
    }
}
